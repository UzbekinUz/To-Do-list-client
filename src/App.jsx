          ...
          <div className="flex items-center justify-center flex-col rounded-[35px] w-[90%] h-[290px]   shadow-lg">
            ...
            <div className="flex relative items-start justify-center mt-[20px]">
              <input
                ...
                value={name}
              />
              <button onClick={()=>{addFunc();setName('')}} className="w-[100px] h-[40px] bg-[#00ADB5] text-[#EEEE] font-bold absolute right-0 rounded-[16px] hover:shadow-md active:scale-90 ">
                Add To List
              </button>
            </div>
            <div className="flex items-center justify-center mt-[15px] w-full gap-[10px]">
              <button className="w-[150px] flex items-center justify-center active:scale-90 h-[35px] text-[18px] rounded-full  text-[#EEEE] bg-[#86003C] shadow-md">
                Sign In
              </button>
              <button className="w-[150px] flex items-center justify-center active:scale-90 h-[35px] text-[18px] rounded-full  text-[#EEEE] bg-[#393E46] shadow-md">
                Sign Up
              </button>
            </div>
          </div>
            ...
            <div className="flex flex-col items-start justify-start w-full min-h-[560px] p-[10px] ">
              ...
              <div className="flex w-full h-[400px] justify-center items-center">
                <div className="flex w-[500px] p-[20px] rounded-lg flex-col justify-center items-center bg-[#00ADB5] ">
                  ...
                  <button onClick={()=>signIn()} className="w-[90%] bg-[#FD7014] h-[35px] rounded-md  justify-center mt-[15px] items-center font-bold text-[#495e9aee] hover:text-[#EEEE] active:scale-90 transition-[0.5] ">
                    Submit
                  </button>
